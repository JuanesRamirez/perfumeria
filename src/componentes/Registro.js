  ...
  return (
    ...
    <div className='formulario'>
      ...
      <div class="form-group">
          ...
          <input type="number" class="form-control" id="inputNumero"  name='identificacion' onChange={handleChange} onClick={idError} placeholder="entre 5 y 10 dígitos"/>
        ...
        <div class="form-group">
          ...
          <input type="email" class="form-control" id="inputEmail" aria-describedby="emailHelp" name='email'onChange={handleChange} onClick={errorEmail} placeholder="debe ser alguien@gmail.com"/>
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="inputTelefono"  name='telefono'onChange={handleChange} onClick={telError} placeholder=" diez números"/>
